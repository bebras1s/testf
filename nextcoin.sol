...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "NextCoin.V1";
    string internal constant SYMBOL = "NXT.V1";
    ...
    uint256 internal constant TOTAL_SUPPLY = 2997924580 * ZEROES;
    uint256 internal _reflectedSupply = (MAX - (MAX % TOTAL_SUPPLY));

    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 10000; // 1% of the total supply
    
    
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 5000; // 2% of the total supply
  
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY / 100000; // 0.1% of the total supply

   
    address internal charityAddress = 0x6BA06c7020f9F78E5Ba5F093F3Ee9669Add64F34;
    address internal marketingAddress = 0x6BA06c7020f9F78E5Ba5F093F3Ee9669Add64F34;


    address internal burnAddress = 0x6BA06c7020f9F78E5Ba5F093F3Ee9669Add64F34;


    address internal tipToTheDev = 0x6BA06c7020f9F78E5Ba5F093F3Ee9669Add64F34;
